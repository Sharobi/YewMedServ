...
public class AccountDTO implements Serializable {
	...
	/**
	 * @param id the id to set AccountID
	 */
	...
	public String toString() {
		return "AccountDTO [id=" + id + ", groupId=" + groupId + ", groupName=" + groupName + ", name=" + name
				...
				+ ", reference_id=" + reference_id + ", type_name=" + type_name + "]";
	}

	public AccountDTO(int id, int groupId, String groupName, String name, String code, int cityId, String cityName,
			int zoneId, String zoneName, int areaId, String areaName, String address, String phone, String pin,
			String email, String panNo, String gstRegistrationNo, String bcdaRegistrationNo, String dlNo,
			double cashDiscountPercentage, double transLimit, int isActive, double opBalance, double outstandingAmount,
			int pst_type_id, String group_name, String pst_type_code, String group_code, double aboveScheme,
			int state_id, int country_id, String state_name, String country_name, String reference_type,
			int reference_id, String type_name) {
		super();
		this.id = id;
		this.groupId = groupId;
		this.groupName = groupName;
