...
public class AccountMaster implements Serializable {
	...
	public AccountMaster(int id, int groupId, String name, String code, int cityId, int zoneId, int areaId,
			String address, String phone, String pin, String email, String panNo, String gstRegistrationNo,
			String bcdaRegistrationNo, String dlNo, double cashDiscountPercentage, double transLimit, int isActive,
			int companyId, int storeId, int isDeleted, int createdBy, Date createdDate, int updatedBy, Date updatedDate,
			String lang, double opBalance, String asOnDate, int finyrId, int pst_type_id, String group_code,
			String reference_type, int reference_id) {
		super();
		this.id = id;
		this.groupId = groupId;
		this.name = name;
