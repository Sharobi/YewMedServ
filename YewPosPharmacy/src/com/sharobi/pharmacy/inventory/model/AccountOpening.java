...
@XmlRootElement
@Entity
@Table(name = "acc_t_account_opening")
public class AccountOpening implements Serializable {
	...
	@Expose
	@Column(name = "pst_type_code")
	private String pstTypeCode;
	
	@Expose
	@Column(name = "pst_type_id")
	...
	public String getPstTypeCode() {
		return pstTypeCode;
	}

	public void setPstTypeCode(String pstTypeCode) {
		this.pstTypeCode = pstTypeCode;
	}
