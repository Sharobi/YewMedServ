...
@XmlRootElement
public class PurchaseReturnLedger implements Serializable {
	...
	public PurchaseReturnLedger(String type, int account_id, double amount) {
		super();
		this.type = type;
		this.account_id = account_id;
		this.amount = amount;
